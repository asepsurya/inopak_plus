...
$tpl_file = "desainer_print.txt";
 if (file_exists($tpl_file)) {
// Alamat file hasil parser
$target = "download/Form_Brainstorming".$id_pengajuan.".txt";
...
$hasilbaca = str_replace("tagline", $tagline, $hasilbaca);
$hasilbaca = str_replace("data_tanggal", $data_tanggal_cetak, $hasilbaca);
$hasilbaca = str_replace("redaksi", $redaksi, $hasilbaca);

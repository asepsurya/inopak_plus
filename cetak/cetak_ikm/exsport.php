...
$excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA IKM $nama_kota"); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$excel->setActiveSheetIndex(0)->setCellValue('C3', "MEREK"); // Set kolom C3 dengan tulisan "NAMA"
$excel->setActiveSheetIndex(0)->setCellValue('D3', "JENIS PRODUK"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
...
while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
	...
	$excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $data['merek']);
	$excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['jenis_produk']);
...
$excel->getActiveSheet()->getColumnDimension('F')->setWidth(70); // Set width kolom F

// Set orientasi kertas jadi LANDSCAPE
$excel->getActiveSheet()->getPageSetup()->setOrientation(PHPExcel_Worksheet_PageSetup::ORIENTATION_LANDSCAPE);

// Set judul file excel nya
$excel->getActiveSheet(0)->setTitle("Laporan Data IKM");
$excel->setActiveSheetIndex(0);

// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Data IKM '.$nama_kota.'.xlsx"'); // Set nama file excel nya

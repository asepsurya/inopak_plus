  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="mg-l-auto hidden-xs-down">
          <a href="data_pengajuan.php" class="btn btn-outline-info mg-l-5"><i class="fas fa-chevron-left"></i> Kembali</a>
        ...
        <div class="card bd-0 shadow-base">
          <table class="table mg-b-0 table-contact">
            ...
            $no=0;
              $query = "SELECT * FROM tb_pengajuan WHERE status='1'";
            ...
            <tr>
               ...
               <?php echo $data2['jenis_produk'] ?>
                 ...
                 <td><span class="badge bg-success tx-white"> Dikonfirmasi</span></td>
